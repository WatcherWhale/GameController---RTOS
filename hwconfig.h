...
#define USART USARTD0						//USART used by the driver
#define USART_PORT PORTD					//Corresponding USART port
#define USART_RXC_vect USARTD0_RXC_vect		//Corresponding USART RXC ISR vector
#define USART_TXC_vect USARTD0_TXC_vect		//Corresponding USART TXC ISR vector
